...
function Login() {
    ...
    try {
      if (currentState === "Sign Up") {
        ...
        if (response.data.success) {
          ...
          setCurrentState("Login"); // Switch to login state after successful registration
        } else {
  ...
  return (
    <form
      ...
      className="flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 mb-32 gap-4 text-gray-800"
    >
